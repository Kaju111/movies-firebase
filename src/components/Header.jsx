...
const Header = () => {
  ...
  return (
    <div className='sticky z-10 bg-black header top-0 text-3xl flex justify-between text-red-500 font-bold p-3 border-b-2 border-gray-500'>
     <Link to={"/"}><span>Filmy<span className='text-white'>verse</span> </span></Link>
      { useAppstate.login ? 
        ...
        :
        <Link to={"/login"}> <h1 className='text-lg bg-green-500 cursor-pointer rounded px-4 flex items-center'>
